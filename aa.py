...
def draw_curve_4_points(p1, p2, p3, p4, p5):
    draw_big_point(p1); draw_big_point(p2); draw_big_point(p3); draw_big_point(p4); draw_big_point(p5)
...
p2 = x2, y2 = random.randint(-500, -100), random.randint(100, 500)
p3 = x3, y3 = random.randint(-300, -100), random.randint(-500, -200)
p4 = x4, y4 = random.randint(200, 400), random.randint(-500, -300)
'''
p1 = -350, -100; p2 = -50, 200; p3 = 150, -100; p4 = 350, 300; p5 = 450, 50
# blend_lines(p2, p3, p4, p1)
# draw_line(p1, p2)
# draw_curve(p1, p2, p3)
draw_curve_4_points(p1, p2, p3, p4, p5)
